...
type
  ...
  TForm3 = class(TForm)
    ...
    procedure GetUsers; //получить список юзеров
  private
...
begin
  ...
  form3.Height:=204;
  if GetEnvironmentVariable('LOGNAME') = 'root' then getusers;
end;
...
begin
  ...
  checkbox3.Enabled:=false;  checkbox3.Checked:=false;
        pt:=ptuser+'.gnome2/nautilus-scripts';
        ...
        pt:=ptuser+'.config/caja/scripts';  // to caja
        ...
        pt:=ptuser+'.kde/share/kde4/services/ServiceMenus';
